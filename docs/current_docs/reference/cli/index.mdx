...
* [dagger module update](#dagger-module-update)	 - Refresh lockfile state for installed modules
...
Refresh lockfile state for installed modules
...
```
dagger module update [module...] [flags]
```
