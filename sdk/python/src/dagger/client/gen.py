...
class Container(Type):
    ...
    def as_tarball(
        ...
        *,
        ...
        """Packages the container state as an OCI image, and return it as a tar
        archive
    ...
    async def publish(
        ...
        *,
        ...
        """Packages the container state as an OCI image, and publish it to a
        registry
    ...
    def rootfs(self) -> "Directory":
        """Returns a snapshot of the container's root filesystem. The snapshot
        can be modified then written back using \"withRootfs\". Use that
        method for filesystem modifications.
        """
        _args: list[Arg] = []
    ...
    def with_directory(
        ...
        *,
        ...
        """Returns a new container snapshot, with a directory added to its
        filesystem
    ...
    def with_entrypoint(
        ...
        *,
        ...
        """Sets an OCI-style entrypoint. It will be included in the container's
    ...
    def with_rootfs(self, directory: "Directory") -> Self:
        """Changes the container's root filesystem. The previous root filesystem
        will be lost.
    ...
    def without_directory(
        ...
        *,
        ...
        """Returns a new container snapshot, with a directory removed from its
        filesystem
...
class Directory(Type):
    ...
    def diff(self, other: Self) -> Self:
        """Returns the difference between this directory and an another
        directory. The difference is encoded as a directory.
