...
impl Container {
    ...
    /// Packages the container state as an OCI image, and return it as a tar archive
    ///
    /// # Arguments
    ///
    /// * `opt` - optional argument, see inner type for documentation, use <func>_opts to use
    ...
    /// Returns the container's OCI entrypoint.
    ...
    /// Packages the container state as an OCI image, and publish it to a registry
    ...
    /// Returns a snapshot of the container's root filesystem. The snapshot can be modified then written back using \"withRootfs\". Use that method for filesystem modifications.
    ...
    /// Returns a new container snapshot, with a directory added to its filesystem
    ///
    /// # Arguments
    ///
    ...
    /// Sets an OCI-style entrypoint. It will be included in the container's OCI configuration. Note, \"withExec\" ignores the entrypoint by default.
    ///
    /// # Arguments
    ///
    ...
    /// Returns a new container snapshot, with a file added to its filesystem
    ///
    /// # Arguments
    ///
    ...
    /// Changes the container's root filesystem. The previous root filesystem will be lost.
    ///
    /// # Arguments
    ///
    ...
    /// Returns a new container snapshot, with a directory removed from its filesystem
    ///
    /// # Arguments
    ///
    ...
    /// Returns a new container spanshot with specified files removed
    ///
    /// # Arguments
    ///
...
impl Directory {
    ...
    /// Returns the difference between this directory and an another directory. The difference is encoded as a directory.
    ///
    /// # Arguments
    ///
    ...
    /// Returns a snapshot with some paths included or excluded
    ///
    /// # Arguments
    ///
    /// * `opt` - optional argument, see inner type for documentation, use <func>_opts to use
    ...
    /// Returns a snapshot with a directory added
    ///
    /// # Arguments
    ///
    ...
    /// Returns a snapshot with a new file added
    ///
    /// # Arguments
    ///
    ...
    /// Returns a snapshot with a subdirectory removed
    ///
    /// # Arguments
    ///
    ...
    /// Returns a snapshot with a file removed
    ///
    /// # Arguments
    ///
    ...
    /// Returns a snapshot with files removed
    ///
    /// # Arguments
    ///
