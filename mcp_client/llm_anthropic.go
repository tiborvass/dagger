...
// //nolint:gocyclo
// func (c *AnthropicClient) SendQuery(ctx context.Context, history []ModelMessage, tools []Tool) (res *LLMResponse, rerr error) {
// 	ctx, span := Tracer(ctx).Start(ctx, "LLM query", Reveal(), trace.WithAttributes(
...
// 	inputTokens, err := m.Int64Gauge(LLMInputTokens)
// 	if err != nil {
// 		return nil, err
// 	}

// 	inputTokensCacheReads, err := m.Int64Gauge(LLMInputTokensCacheReads)
// 	if err != nil {
// 		return nil, err
// 	}

// 	inputTokensCacheWrites, err := m.Int64Gauge(LLMInputTokensCacheWrites)
// 	if err != nil {
// 		return nil, err
// 	}

// 	outputTokens, err := m.Int64Gauge(LLMOutputTokens)
// 	if err != nil {
// 		return nil, err
// 	}
