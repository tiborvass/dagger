...
func (c *OpenAIClient) SendQuery(ctx context.Context, history []ModelMessage, tools []Tool) (_ *LLMResponse, rerr error) {
	ctx, span := Tracer().Start(ctx, "LLM query", Reveal(), trace.WithAttributes(
